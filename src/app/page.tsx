      ...
      <section className="max-w-3xl mx-auto px-6 py-12 text-center">
        ...
        <ol className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm text-[#1a3a52]/80">
          <li>
            ...
            <p>
              Pick your setup, dates, and beach access point. Pay your
              reservation fee in 60 seconds.
            </p>
          </li>
          <li>
            <p className="font-bold text-[#1a3a52] mb-2">2. We set up</p>
            <p>
              Crew shows up at your access point in the morning, sets
              everything up exactly where you want it.
            </p>
          </li>
          <li>
            <p className="font-bold text-[#1a3a52] mb-2">3. We break down</p>
            <p>
              End of day, we come back and break it down. You don&apos;t
              haul anything home.
            </p>
          </li>
        </ol>
